...
const initialMenuData: MenuItem[] = [
  // 디저트 (Hot/Ice 구분 없음)
  { id: 1, category: "디저트", name: "버터떡 5ea", image: "/menu/butter-tteok.png", price: 7500, hotQty: 0, iceQty: 0, hasTempOption: false },
  { id: 2, category: "디저트", name: "시그니처 치즈박스", image: "/menu/signature-cheesebox.png", price: 4500, hotQty: 0, iceQty: 0, hasTempOption: false },
  { id: 3, category: "디저트", name: "블루베리 치즈박스", image: "/menu/blueberry-cheesebox.png", price: 5000, hotQty: 0, iceQty: 0, hasTempOption: false },
  { id: 4, category: "디저트", name: "플레인 휘낭시에", image: "/menu/plain-financier.png", price: 2900, hotQty: 0, iceQty: 0, hasTempOption: false },
  { id: 5, category: "디저트", name: "무화과 크림치즈 휘낭시에", image: "/menu/fig-cream-financier.png", price: 3500, hotQty: 0, iceQty: 0, hasTempOption: false },
  { id: 6, category: "디저트", name: "소금초코 휘낭시에", image: "/menu/salt-choco-financier.png", price: 3500, hotQty: 0, iceQty: 0, hasTempOption: false },
  { id: 7, category: "디저트", name: "아몬드 휘낭시에", image: "/menu/almond-financier.png", price: 3300, hotQty: 0, iceQty: 0, hasTempOption: false },
  { id: 8, category: "디저트", name: "얼그레이 화이트 마들렌", image: "/menu/earlgrey-madeleine.png", price: 3500, hotQty: 0, iceQty: 0, hasTempOption: false },
  { id: 9, category: "디저트", name: "피칸 에스프레소 마들렌", image: "/menu/pecan-espresso-madeleine.png", price: 3500, hotQty: 0, iceQty: 0, hasTempOption: false },
  { id: 10, category: "디저트", name: "플레인 마들렌", image: "/menu/plain-madeleine.png", price: 2900, hotQty: 0, iceQty: 0, hasTempOption: false },
  { id: 11, category: "디저트", name: "월넛 초코 르뱅쿠키", image: "/menu/walnut-choco-levain.png", price: 4500, hotQty: 0, iceQty: 0, hasTempOption: false },
  { id: 12, category: "디저트", name: "말차 마카다미아 르뱅쿠키", image: "/menu/matcha-macadamia-levain.png", price: 5000, hotQty: 0, iceQty: 0, hasTempOption: false },
  { id: 13, category: "디저트", name: "아몬드 청키초코 르뱅쿠키", image: "/menu/almond-chunky-levain.png", price: 5000, hotQty: 0, iceQty: 0, hasTempOption: false },
  { id: 14, category: "디저트", name: "두바이 쫀득쿠키", image: "/menu/dubai-cookie.png", price: 5500, hotQty: 0, iceQty: 0, hasTempOption: false },
  // 음료 (Hot/Ice 선택 가능)
